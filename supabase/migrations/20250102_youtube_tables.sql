-- Migration: Add YouTube support tables
-- Created: 2025-01-02
-- Description: Adds youtube_drafts table and updates oauth_tokens for YouTube

-- Update oauth_tokens to support YouTube
...
-- Create indexes for youtube_drafts
...
-- RLS Policies for youtube_drafts
